...
int main(int argc, char* argv[])
{
	...
	if(argc!=10){
		printf("./main [outfileheader] [sub_entries] [sampling_rate(Hz)] [sampling_number] [+/-dynamic range(V)] [ch1 Vth(V)] [ch2 Vth(V)] [trigger source 0(ch1) or 1(ch2) or 2(or)] [Trig Edge RISE=0 or FALL=1]\n");
	...
	fprintf(fconf,"DYNAMIC RANGE          : %.3lf (V)\n",dynamic_range);
