...
void DrawGainCurve()
{
    ...
    std::string dataFile = "./calData.dat";
    ...
    tgeGainCurve->GetXaxis()->SetLimits(0, 0.35);
    tgeGainCurve->GetYaxis()->SetRangeUser(0, 60);
    tgeGainCurve->Draw("AP");

    // Fitting
    TF1 *fit = new TF1("fit", "pol1", 0, 0.35);
    ...
    latex->DrawLatex(0.05, 50, Form("Slope  = %.2lf #pm %.2lf", slope, slopeErr));
    latex->DrawLatex(0.05, 45, Form("Offset = %.2lf #pm %.2lf", offset, offsetErr));
